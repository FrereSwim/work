        ...
        <div id="pf-bd">
                ...
                <ul class="sider-nav">
                      <li>
                        <a href="javascript:;">
                            ...
                            <span class="sider-nav-title">货品管理</span>
                            <i class="iconfont">&#xe642;</i>
                        </a>
                        <ul class="sider-nav-s">
                           <li><a href="javascript:addTag('../warehousePage/goodsList.html');">明细管理</a></li>
                        </ul>
                     </li>
                 </ul> 
            </div>
            ...
            <div id="pf-page">
                <div id="easyui-tabs1" class="easyui-tabs1" style="width:100%;height:100%;">
	                <iframe id="iframe"  style="padding:10px 5px 5px 10px;" class="page-iframe" src="pageShow.html?name=warehouse" frameborder="no"   border="no" height="100%" width="100%" scrolling="auto"></iframe>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
	...
	$(".pf-name").click(function a(){
		 ...
		 $(".sider-nav-s li").attr("class","");
		 addTag("pageShow.html?name=warehouse");
	 });
    // setTimeout(function(){
    //    $('.tabs-panels').height($("#pf-page").height()-46);
    //    $('.panel-body').height($("#pf-page").height()-76)
