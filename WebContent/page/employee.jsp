                ...
                <ul class="sider-nav">
                      <li>
                        <a href="javascript:;">
                            ...
                            <span class="sider-nav-title">员工信息管理</span>
                            <i class="iconfont">&#xe642;</i>
                        </a>
                        <ul class="sider-nav-s">
                           <li><a href="javascript:addTag('../employeePage/employeeList.html?dType=1');">行政层</a></li>
                           <li><a href="javascript:addTag('../employeePage/employeeList.html?dType=2');">管理层</a></li>
                           <li><a href="javascript:addTag('../employeePage/employeeList.html?dType=3');">普通员工</a></li>
                           <li><a href="javascript:addTag('../employeePage/departmentList.html')">职位信息</a></li>
                        </ul>
                     </li>
                     <li>
                        <a href="javascript:;">
                            <span class="iconfont sider-nav-icon"></span>
                            <span class="sider-nav-title">考勤管理</span>
                            <i class="iconfont">&#xe642;</i>
                        </a>
                        <ul class="sider-nav-s">
                     ...
                     <li>
                        <a href="javascript:;">
                            <span class="iconfont sider-nav-icon"></span>
                            <span class="sider-nav-title">合同管理</span>
                            <i class="iconfont">&#xe642;</i>
                        </a>
                        <ul class="sider-nav-s">
                     ...
                     <li>
                        <a href="javascript:;">
                            <span class="iconfont sider-nav-icon"></span>
                            <span class="sider-nav-title">辅助功能</span>
                            <i class="iconfont">&#xe642;</i>
                        </a>
                        <ul class="sider-nav-s">
